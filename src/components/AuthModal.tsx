      ...
      >
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <div className="flex items-start space-x-3 py-2">
              <div 
                ...
                className={`flex-shrink-0 w-5 h-5 rounded border transition-all cursor-pointer flex items-center justify-center ${accepted ? 'bg-emerald-500 border-emerald-500' : 'border-slate-300 bg-white hover:border-emerald-400'}`}
              >
            ...
            <button 
              ...
              className="w-full gradient-btn py-3 rounded-xl text-white font-bold shadow-lg shadow-emerald-200 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <button 
            ...
            disabled={loading || !accepted}
            className="w-full py-3 bg-white border border-slate-200 rounded-xl text-slate-700 font-bold flex items-center justify-center space-x-3 hover:bg-slate-50 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
          >
